...
public class login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addComponent(connect, javax.swing.GroupLayout.PREFERRED_SIZE, 51, javax.swing.GroupLayout.PREFERRED_SIZE))
        );
    ...
    private void connectActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_connectActionPerformed
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this, "Could not connect due to : " + e.getMessage());
            System.exit(0);
        }
    ...
    private Connection setConnection() {
        ...
        try {
            String driverName = "oracle.jdbc.OracleDriver";//oracle.jdbc.OracleDriver
